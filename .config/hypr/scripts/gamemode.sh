...
if [ "$HYPRGAMEMODE" = 1 ]; then
        ...
        keyword decoration:shadow:xray 0;\
        keyword decoration:blur:enabled 0;\
        keyword misc:render_ahead_of_time:enabled 0;\
        keyword misc:render_ahead_safezone:enabled 0;\
        ...
        hyprctl 'keyword windowrule noanim,class:(.*)' # ensure all windows are opaque 
        exit
else
